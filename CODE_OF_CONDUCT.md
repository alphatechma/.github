...
- Dar e receber feedbacks construtivos de forma cordial.
...
- Comentários ofensivos (*trolling*), insultuosos ou depreciativos, e ataques pessoais ou políticos.
...
As lideranças da comunidade são responsáveis por esclarecer e fazer cumprir nossos padrões de comportamento aceitável e tomarão ações corretivas apropriadas e justas em resposta a qualquer comportamento considerado inadequado, ameaçador, ofensivo ou prejudicial.

## Abrangência

Este Código de Conduta se aplica em todos os espaços da comunidade e também quando uma pessoa representa oficialmente a comunidade em espaços públicos.
